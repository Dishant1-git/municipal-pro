                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="flex items-center gap-6">
                            <a href="mailto:support@admin.com" className="flex items-center gap-2 hover:text-white transition-colors font-medium">
                                <i className="fal fa-envelope text-primary text-lg"></i> support@admin.com
                            </a>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <ul class="mega-menu-item with-list parent-nav">
                                                                    <li><Link><i class="fa-sharp fa-regular fa-chevron-right"></i>User List</Link></li>
                                                                     <li><Link><i class="fa-sharp fa-regular fa-chevron-right"></i>Worker List</Link></li>
